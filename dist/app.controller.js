...
const csv_service_1 = require("./module/csv/csv.service");
let AppController = class AppController {
    constructor(appService, csvSevice) {
        this.appService = appService;
        this.csvSevice = csvSevice;
    }
...
], AppController.prototype, "logDiscordPrecenseCount", null);
